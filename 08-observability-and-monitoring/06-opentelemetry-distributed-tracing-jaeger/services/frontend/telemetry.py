"""OpenTelemetry initialization and tracing utilities for frontend-service."""
...
def init_telemetry(service_name: str = "frontend-service") -> trace.Tracer:
    """Initialize OpenTelemetry TracerProvider, OTLP exporter, and W3C propagator."""
    # Set W3C Trace Context as the global text map propagator
    ...
    resource = Resource.create(
        {
            ...
            "host.name": os.getenv("HOSTNAME", "frontend-service"),
    ...
    # BatchSpanProcessor with low schedule delay for immediate tracing visibility
