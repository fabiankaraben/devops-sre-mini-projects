"""OpenTelemetry initialization and tracing utilities for auth-service."""
...
def init_telemetry(service_name: str = "auth-service") -> trace.Tracer:
    """Initialize OpenTelemetry TracerProvider, OTLP exporter, and W3C propagator."""
    # Set W3C Trace Context as global propagator to automatically extract incoming headers
    ...
    resource = Resource.create(
        {
            ...
            "host.name": os.getenv("HOSTNAME", "auth-service"),
